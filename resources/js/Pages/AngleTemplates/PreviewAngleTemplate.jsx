...
`;
    ...
    // Backward compatibility: form_type in HTML but api_category_id missing — set platform from mapping
    useEffect(() => {
    ...
    const updateHTMLHandler = async () => {
        ...
        if ((editing.actionType == "edit" && ['div', 'h1', 'h2', 'h3', 'h4', 'h5', 'h6', 'a', 'i', 'p', 'span', 'text', 'rect', 'tspan', 'svg'].includes(editing.elementName)) || (editing.actionType === "add" && editing.addElementType == "p")) {
            ...
            // Add OTP modal fields as hidden inputs
                                                        ...
                                                        {selectedApiPlatform && platformInstances.length > 0 && (
                                                            <Box mt={2}>
                                                                <FormControl fullWidth required>
                                                                    <InputLabel id="angle-template-form-type-label" shrink>
                                                                        API integration
                                                                    </InputLabel>
                                                                    <MuiSelect
                                                                        labelId="angle-template-form-type-label"
                                                                        value={
                                                                            formManagement.apiInstanceId != null &&
                                                                            formManagement.apiInstanceId !== ''
                                                            ...
                                                            <Box mt={2}>
                                                                ...
                                                                <Box sx={{ mt: 2 }}>
                                                                    ...
                                                                    <TextField
                                                                        ...
                                                                        placeholder="Due to heavy demand, as well as user fraud, we are now asking all users to verify their phone numbers. (Your Company Name) values your time as well as our advisors."
