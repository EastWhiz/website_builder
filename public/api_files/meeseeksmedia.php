...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $ch = curl_init('https://mskmd-api.com/api/v2/leads');
    ...
    if ($isSelfHosted) {
        ...
        saveLead($postData, $getData, $responseArray, 'meeseeksmedia', 'success', $data);
    ...
    saveLead($postData, $getData, $responseArray, 'meeseeksmedia', $leadSaveStatus, $data);
