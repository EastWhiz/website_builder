...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $ch = curl_init('https://platform.onlinepartnersed.com/api/signup/procform');
    ...
    if ($isSelfHosted) {
        ...
        saveLead($postData, $getData, $responseArray, 'tigloo', 'success', $data);
    ...
    saveLead($postData, $getData, $responseArray, 'tigloo', $leadSaveStatus, $data);
