...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Setup cURL to call the Seamediaone Trackbox API
    $ch = curl_init('https://tb.seamediaone.net/api/signup/procform');

    // Prepare the data for Seamediaone API
    $data = array(
        'ai' => '',
        'ci' => '',
        'gi' => '',
    ...
    if ($isSelfHosted) {
        ...
        saveLead($postData, $getData, $responseArray, 'seamediaone', 'success', $data);
    ...
    // Set cURL options for the Seamediaone API request
    ...
    saveLead($postData, $getData, $responseArray, 'seamediaone', $leadSaveStatus, $data);
