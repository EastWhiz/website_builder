...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Setup cURL to call the NewMedis Trackbox API
    $ch = curl_init('https://tb.newmedis.live/api/signup/procform');

    // Prepare the data for NewMedis API
    $data = array(
        'ai' => '',
        'ci' => '',
        'gi' => '',
    ...
    if ($isSelfHosted) {
        ...
        saveLead($postData, $getData, $responseArray, 'newmedis', 'success', $data);
    ...
    // Set cURL options for the NewMedis API request
    ...
    saveLead($postData, $getData, $responseArray, 'newmedis', $leadSaveStatus, $data);
