...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Prepare the data for RiceLeads API
    $data = array(
        'affid' => '36',
    ...
    if ($isSelfHosted) {
        ...
        saveLead($postData, $getData, $responseArray, 'riceleads', 'success', $data);
    ...
    // Initialize cURL to call RiceLeads API
    $ch = curl_init('https://ridapi.net/leads');
    ...
    saveLead($postData, $getData, $responseArray, 'riceleads', $leadSaveStatus, $data);
